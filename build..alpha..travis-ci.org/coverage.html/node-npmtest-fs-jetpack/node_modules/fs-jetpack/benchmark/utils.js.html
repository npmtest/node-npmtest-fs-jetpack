...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-fs-jetpack/node_modules/fs-jetpack/benchmark/utils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-fs-jetpack/node_modules/fs-jetpack/benchmark/utils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-fs-jetpack/node_modules/fs-jetpack/benchmark/</a> &#187; utils.js</div>
</div>
<div class="body">
...
var humanReadableFileSize = function (bytes, si) {
  ...
  var u;
  var b = bytes;
  var thresh = si ? 1000 : <span class="branch-1 cbranch-no" title="branch not covered" >1024;</span>
  <span class="missing-if-branch" title="if path not taken" >I</span>if (Math.abs(b) &lt; thresh) {
<span class="cstat-no" title="statement not covered" >    return b + ' B';</span>
  }
  units = si
    ? ['kB', 'MB', 'GB', 'TB']
    : <span class="branch-1 cbranch-no" title="branch not covered" >['KiB', 'MiB', 'GiB', 'TiB'];</span>
  u = -1;
  do {
    b /= thresh;
    ++u;
